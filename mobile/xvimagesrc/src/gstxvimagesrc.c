...
gst_xv_image_src_create (GstPushSrc * psrc, GstBuffer ** buffer)
{
  ...
  if(g_queue_is_empty (src->queue)) {
    ...
    while((tempbuf = (GstXvImageOutBuffer*)g_queue_pop_head(src->queue)) != NULL)
    {
