...
void gst_piffdemux_set_video_params (GstPiffDemux * piffdemux, guint fourcc, guint width, guint height, guint fps_n, guint fps_d, unsigned char *codec_data, unsigned int codec_data_len);
/* prepares audio caps based on input params */
void gst_piffdemux_set_audio_params (GstPiffDemux * piffdemux, guint fourcc,
